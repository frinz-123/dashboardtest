        ...
        <div className="grow space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-sm text-muted-foreground">
              Ventas Actuales: <span className="font-semibold text-foreground">{formatCurrency(used)}</span>
            </span>
            <span className="text-base font-semibold text-foreground">{percent.toFixed(1)}%</span>
          </div>

          <div>
            <Progress value={percent} className="bg-muted h-2" indicatorClassName="bg-indigo-500" />
          </div>

          <div className="flex items-center justify-between">
            <span className="text-sm font-semibold text-foreground">{formatCurrency(remaining)} restantes</span>
            <span className="text-xs text-muted-foreground">de {formatCurrency(total)} meta {periodLabel}</span>
          </div>
        </div>
