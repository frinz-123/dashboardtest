...
export default function VendorSelector({ 
  ...
  const currentVendorLabel = currentVendor ? getVendorLabel(currentVendor) : 'Todas las Rutas'
    ...
    <div className="bg-blue-50 rounded-lg p-3 mb-4 border border-blue-200">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center">
          ...
          <span className="text-sm font-medium text-blue-800">Cuenta Maestra</span>
        </div>
            ...
            <div className="py-1">
              <button
                ...
                className={`w-full px-3 py-2 text-left text-sm hover:bg-gray-100 transition-colors ${
                  !currentVendor ? 'bg-blue-50 text-blue-700 font-medium' : 'text-gray-700'
                }`}
              >
              ...
              {vendors.map((vendor) => (
                <button
                  ...
                  className={`w-full px-3 py-2 text-left text-sm hover:bg-gray-100 transition-colors ${
                    currentVendor === vendor.email ? 'bg-blue-50 text-blue-700 font-medium' : 'text-gray-700'
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <div>
