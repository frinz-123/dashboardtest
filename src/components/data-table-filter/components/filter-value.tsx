...
export function FilterValueOptionController<TData>({
  ...
  // Recompute options when the column reference changes (e.g. after async options load)
  ...
  // Sync options list whenever the column's options change (e.g. after server data loads)
  useEffect(() => {
