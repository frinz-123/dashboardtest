...
import FeedPost, { type FeedSale } from "./FeedPost";
...
export default function FeedTab({
  ...
  }, [salesData, getTimeFromSubmission]);
  ...
  const filteredSales = useMemo(() => {
    ...
    if (selectedDate) {
      result = result.filter((sale) => sale.fechaSinHora === selectedDate);
    }
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          ...
          <div className="p-3 flex items-center gap-2 overflow-x-auto">
            ...
            >
              ...
              <span>{selectedPeriod ? `P${selectedPeriod}` : "Periodo"}</span>
              {selectedPeriod && (
                <X
                  className="w-3.5 h-3.5 ml-0.5"
                  onClick={(e) => {
            ...
            <div className="border-t border-gray-100 p-3 max-h-48 overflow-y-auto">
              <div className="space-y-1">
                ...
                {availablePeriods.map((period) => (
                  ...
                  >
                    <span>Periodo {period.periodNumber}</span>
                    <span className="text-xs text-gray-400">
                      {period.label}
                    </span>
                  </button>
