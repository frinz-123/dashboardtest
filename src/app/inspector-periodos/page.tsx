...
export default function InspectorPeriodosPage() {
    ...
    const [expandedPhotoUrl, setExpandedPhotoUrl] = useState<string | null>(
        null,
    );
    ...
    const filteredSales = useMemo(() => {
        ...
        return salesData.filter((sale) => {
            ...
            if (selectedWeek && !selectedDay) {
                ...
                if (
                    week &&
                    !isDateInPeriod(saleDate, week.weekStart, week.weekEnd)
                )
                    return false;
            }
        ...
        return sellers
            .map((email) => {
                ...
                return {
                    ...
                    salesCount: sellerSales.filter((sale) => sale.venta > 0)
                        .length,
                    efectivoSales,
                };
            })
    ...
    const productsSold = useMemo(() => {
        ...
        for (const sale of salesToUse) {
            if (sale.products) {
                for (const [product, quantity] of Object.entries(
                    sale.products,
                )) {
    ...
    const dailySalesChartData = useMemo(() => {
        ...
        filteredSales.forEach((sale) => {
            const dateStr = new Date(sale.fechaSinHora)
                .toISOString()
                .split("T")[0];
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
                <div className="bg-white rounded-xl p-6 text-center max-w-md">
                    ...
                    <p className="text-gray-600 mb-4">
                        Solo los administradores pueden acceder al Inspector de
                        Periodos.
                    </p>
                    <Link href="/" className="text-blue-600 hover:underline">
                        Volver al Dashboard
                            ...
                            <>
                                ...
                                <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
                                    ...
                                    <div className="bg-white rounded-xl p-4 border border-gray-200">
                                        ...
                                        <p className="text-xl font-bold text-gray-800">
                                            {currentSellerStats.progress.toFixed(
                                                2,
                                            )}
                                            %
                                        </p>
                            ...
                            <>
                                ...
                                {summaryStats && (
                                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                                        <div className="bg-white rounded-xl p-4 border border-gray-200">
                                            ...
                                            <p className="text-xl font-bold text-gray-800">
                                                {formatCurrency(
                                                    summaryStats.totalTeamSales,
                                                )}
                                            </p>
                                            <p className="text-xs text-gray-500 mt-1">
                                                de{" "}
                                                {formatCurrency(
                                                    summaryStats.totalTeamGoal,
                                                )}{" "}
                                                meta
                                            </p>
                                        </div>
                                        ...
                                        <div className="bg-white rounded-xl p-4 border border-gray-200">
                                            ...
                                            <p className="text-xl font-bold text-gray-800">
                                                {summaryStats.avgProgress.toFixed(
                                                    2,
                                                )}
                                                %
                                            </p>
                                ...
                                <div className="bg-white rounded-xl border border-gray-200 overflow-hidden mb-6">
                                    <div className="px-4 py-3 border-b border-gray-200 flex items-start justify-between">
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500">
                                                Haz clic en un vendedor para ver
                                                su detalle completo
                                            </p>
                                            {isHideModeEnabled &&
                                ...
                                <div className="bg-white rounded-xl border border-gray-200 overflow-hidden mb-6">
                                    <div className="px-4 py-3 border-b border-gray-200">
                                        ...
                                        <p className="text-xs text-gray-500">
                                            Distribucion de productos vendidos
                                            en el periodo
                                        </p>
                                    </div>
                                    {productsSold.length > 0 ? (
                        ...
                        <div className="p-4 overflow-y-auto">
                            ...
                            <div>
                                <h4 className="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
                                    <ShoppingBag className="w-4 h-4" />
                                    Productos (
                                    {Object.keys(selectedSale.products).length})
                                </h4>
